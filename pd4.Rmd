...
tratamiento, 0 si es control).

• Postt → Variable binaria (1 si el periodo tt es posterior a la
intervención, 0 si es antes).
...
• β1 → Diferencia inicial entre grupos (tratamiento vs. control) antes
de la intervención.

• β2 → Cambio temporal común (efecto de tendencia en el grupo de
control).
